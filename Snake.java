...
public class Snake {
  ...
  private static ShowStatictics showStatictics;
  ...
  public static void returnToMainMenu() {
    ...
    // if window of statistics is open(not application), close
    if ((showStatictics != null) && (!showStatictics.isDisposed())) {
      showStatictics.dispose();
    }
    // then open main menu
  ...
  public static void handleShowStatisticsBtn(Event event) {
    if ((startMenu != null) && (!startMenu.isDisposed())) {
      startMenu.dispose();
    }
    showStatictics = new ShowStatictics(shell);
    showStatictics.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
    showStatictics.forceFocus();
    shell.layout(true);
  }
